# Page Reading Agent Backend / 页面阅读代理后端
...
- Root README: `page-reading-agent-backend`
- Previous docs index: `Documentation`
- Manifest evidence / 构建清单: package.json (`page-reading-agent`)
- Active code and ops directories / 当前主要目录: no primary implementation directories were detected automatically
